...
final class AddBranchPremiumRevenueOracleMapping extends Migration
{
    private const SOURCE = 'Pendapatan premi penjaminan kredit';
    private const TARGET = 'Imbal Jasa Penjaminan Bruto';

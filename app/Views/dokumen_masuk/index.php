...
<section class="page-heading security-page-heading">
    <div>
        ...
        <h1>Dokumen Masuk</h1>
        <p>Arsip baca-saja untuk dokumen masuk yang telah selesai diserahkan melalui Distribusi Dokumen.</p>
    </div>
</section>
...
<section class="panel filter-panel security-filter-panel">
    <form method="get" action="<?= site_url('dokumen-masuk') ?>" class="filter-form">
        ...
        <div class="form-group"><label for="jenis">Jenis</label><select id="jenis" name="jenis">
        ...
        <?= view('components/list_order_filter', ['id' => 'dokumen_masuk_urutan', 'value' => $filters['order']]) ?>

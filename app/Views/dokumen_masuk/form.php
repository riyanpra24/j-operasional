...
<form action="<?= esc($action) ?>" method="post" class="data-form"><?= csrf_field() ?>
    <section class="panel form-section"><div class="section-heading"><span class="section-number">01</span><div><h2>Informasi dokumen</h2><p>Lengkapi data sesuai buku register dokumen masuk.</p></div></div><div class="form-grid">
        ...
        <div class="form-group"><label for="jenis">Jenis <span class="required">*</span></label><input id="jenis" name="jenis" list="jenis-list" maxlength="100" value="<?= esc($v('jenis')) ?>" required><datalist id="jenis-list"><option value="Surat"><option value="Dokumen"><option value="Berkas"><option value="Paket"></datalist></div>

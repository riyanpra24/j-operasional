<div class="delete-modal" id="reopenProgressModal" hidden aria-hidden="true">
    ...
    <section class="modal-dialog delete-modal-dialog" role="alertdialog" aria-modal="true" aria-labelledby="reopenProgressTitle" aria-describedby="reopenProgressDescription">
        <div class="delete-modal-body">
            ...
            <h2 id="reopenProgressTitle">Kembalikan ke Progres Dokumen?</h2>
            <p id="reopenProgressDescription"><strong data-reopen-progress-label></strong> akan hilang dari arsip dan kembali ke Progres Dokumen agar dapat diedit.</p>
        ...
        <form method="post" action="" data-reopen-progress-form class="delete-modal-actions">
            ...
            <button type="submit" class="btn btn-primary" data-reopen-progress-submit>Ya, kembalikan ke progres</button>
        </form>
    </section>
</div>

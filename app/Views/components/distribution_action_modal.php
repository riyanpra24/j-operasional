<div class="distribution-action-modal" id="distributionActionModal" hidden aria-hidden="true">
    ...
    <section class="modal-dialog distribution-action-dialog" role="dialog" aria-modal="true" aria-labelledby="distributionActionTitle">
        <header class="modal-header">
            <div class="modal-title-group"><span class="modal-title-icon distribution-title-icon">⇢</span><div><p>PROSES DISTRIBUSI</p><h2 id="distributionActionTitle">Penyerahan Dokumen</h2></div></div>
        ...
        <form method="post" action="" data-distribution-form hidden>
            ...
            <div class="modal-body">
                ...
                <div class="modal-section-heading pickup-heading"><span>02</span><div><strong>Penyerahan</strong><small>Field ini hanya dapat diisi satu kali dari menu Distribusi Dokumen</small></div></div>
                <div class="form-group pickup-field"><label for="distribution_pengambilan">Penyerahan <span class="required">*</span></label><input id="distribution_pengambilan" name="pengambilan" maxlength="255" placeholder="Nama petugas atau keterangan penyerahan" required><small>Setelah disimpan, dokumen keluar dari antrean distribusi.</small></div>
            </div>
            <footer class="modal-footer"><span class="modal-submit-status" data-distribution-status></span><button type="button" class="btn btn-ghost" data-distribution-close>Batal</button><button type="submit" class="btn btn-primary" data-distribution-submit>Simpan penyerahan</button></footer>
        </form>
    </section>
</div>
